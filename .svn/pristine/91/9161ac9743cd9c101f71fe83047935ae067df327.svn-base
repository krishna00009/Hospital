app.controller('MedicineController',
    function($scope, $http, $location, $filter, Notification, ngTableParams,  $timeout, $window, $rootScope) {
        ...
        $scope.saveMedicine = function () {
            ...
            else if (angular.isUndefined($scope.uom) || $scope.uom == ''||$scope.uom==null) {
                Notification.warning({message: 'Please Select Unit Of Measurement', positionX: 'center', delay: 2000});
