...
public interface ServicesRepository extends JpaRepository<Services, Long> {
    ...
    List<Services> findAllByNameContaining(String typeName,Sort sort);
    ...
    List<Services> findAllByIdservicecategories(ServiceCategories serviceCategories,Sort sort);
