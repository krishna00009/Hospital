app.controller('customersController',
    function($scope, $http, $location, $filter, Notification, ngTableParams,  $timeout, $window, $rootScope) {
        ...
        $scope.EditCustomers = function (data) {
            ...
            document.getElementById('SelectAppointmentDisease').value=data.cheifComplaints;
        ...
        $scope.getCustomersList = function (searchText) {
            ...
            $http.post($scope.hospitalServerURL + '/getCustomers?&userid='+$rootScope.loginUserId).then(function (response) {
        ...
        $scope.saveCustomers = function () {
            if (angular.isUndefined($scope.firstname) || $scope.firstname == ''|| $scope.firstname== null) {
                ...
                saveCustomerDetails = {
                    ...
                    city:$scope.city,
                    sympton: SelectAppointmentDisease,
