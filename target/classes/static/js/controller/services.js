app.controller('servicesController',
    function($scope, $http, $location, $filter, Notification, ngTableParams,  $timeout, $window, $rootScope) {
        ...
        $scope.saveServicesImport = function(){
            ...
            $http.post($scope.hospitalServerURL + '/serviceImportSave',serviceDetails,
        ...
        $scope.saveMedplus = function () {
            if (angular.isUndefined($scope.medicine) || $scope.medicine == ''|| $scope.medicine == null) {
                Notification.warning({message: 'Please Select Medicine', positionX: 'center', delay: 2000});

            }
            else if (angular.isUndefined($scope.quantity) || $scope.quantity == ''|| $scope.quantity == null) {
                Notification.warning({message: 'Please Select Quantity', positionX: 'center', delay: 2000});
